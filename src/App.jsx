...
{tab === "quiz" && <QuizPage categories={cat.categories} translations={trans.translations} />}
</main>


<footer className="app-footer">Data is stored in your browser (localStorage).</footer>
</div>
);
}